...
**[v0.1.6](https://github.com/stoatworks-labs/tilter/releases/tag/v0.1.6)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`tilter-0.1.6-macos-universal.dmg`](https://github.com/stoatworks-labs/tilter/releases/download/v0.1.6/tilter-0.1.6-macos-universal.dmg) | 216 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`tilter-0.1.6-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/tilter/releases/download/v0.1.6/tilter-0.1.6-windows-x86_64-setup.exe) | 220 KB |
