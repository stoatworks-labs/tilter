...
**[v0.1.5](https://github.com/stoatworks-labs/tilter/releases/tag/v0.1.5)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`tilter-0.1.5-macos-universal.dmg`](https://github.com/stoatworks-labs/tilter/releases/download/v0.1.5/tilter-0.1.5-macos-universal.dmg) | 216 KB |
| Universal (Apple Silicon + Intel) · .zip archive | [`tilter-macos-universal.zip`](https://github.com/stoatworks-labs/tilter/releases/latest/download/tilter-macos-universal.zip) | 179 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`tilter-0.1.5-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/tilter/releases/download/v0.1.5/tilter-0.1.5-windows-x86_64-setup.exe) | 220 KB |
